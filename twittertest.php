...
r[c]+'" class="twitter_reply_icon"'+(v?' target="_blank">':">")+'<img src="images/reply.png" style="width:50%;"></a><a href="https://twitter.com/intent/retweet?tweet_id='+r[c]+'" class="twitter_retweet_icon"'+(v?' target="_blank">':">")+'<img src="images/retweet.png" style="width:50%;"></a><a href="https://twitter.com/intent/favorite?tweet_id='+r[c]+'" class="twitter_fav_icon"'+(v?' target="_blank">':">")+"<img src='images/like.png' style='width:50%;'></a></p>");u&&void 0!==h[c]&&void 0!==y(h[c])&&(d+='<div class="media"><img src="'+y(h[c])+'" alt="Image from tweet" /></div>');u?b.push(d):!u&&a[c].textContent.length&&
