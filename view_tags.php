...
$query=mysqli_query($conn,"select * from blog_posts where tags LIKE '%" . $tags . "%' ORDER BY postDate DESC, postTIME DESC limit $start, $limit");
$tot=mysqli_query($conn, "select * from blog_posts where tags LIKE '%" . $tags . "%' ORDER BY postDate DESC, postTIME DESC");
...
function pagination($page,$num_page, $tags)
{
